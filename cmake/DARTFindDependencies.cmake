...
# GSL for multidimensional root finding
find_package(GSL)
if(GSL_FOUND)
  message(STATUS "Looking for GSL - ${GSL_VERSION} found")
else()
  message(SEND_ERROR "Looking for GSL - NOT found, please install libfcl-dev (>= 0.2.9)")
endif()
